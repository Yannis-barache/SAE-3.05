...
class TestMatch(unittest.TestCase):
    ...
    def test_constructeur(self):
        ...
        escrimeur1 = Escrimeur(1, 'Chédeville', 'Baptiste', '2004-14-05',
                               'baptched', 'baptiste.chedeville@gmail.com',
                               'mdp', 'AB21', 1, club)
        escrimeur2 = Escrimeur(2, 'Evelin', 'Colomban', '2004-14-05', 'clb',
                               'Evelin.Colomban@gmail.com', 'mdp', 'AB11', 2,
                               club)
    ...
    def test_str(self):
        ...
        self.assertEqual(
            ...
            '2 - Evelin - Colomban - 2004-14-05 - clb - Evelin.Colomban@gmail.com - '
