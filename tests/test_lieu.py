...
class TestLieu(unittest.TestCase):
    ...
    def test_get_nom(self):
        """
        Test de la fonction get_nom de la classe Lieu
        """
        lieu = Lieu(1, 'Paris', 'Une grande ville', 'Paris France')
        self.assertEqual(lieu.get_nom(), 'Paris')
    ...
    def test_set_nom(self):
        """
        Test de la fonction set_nom de la classe Lieu
        """
        lieu = Lieu(1, 'Paris', 'Une grande ville', 'Paris France')
        lieu.set_nom('Lyon')
        self.assertEqual(lieu.get_nom(), 'Lyon')
