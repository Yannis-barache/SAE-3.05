...
class TestException(TestClubBD):
    ...
    def setUp(self):
        super().setUp()
        modele2 = ModeleAppli()
        self.club_bd2 = modele2.get_club_bd()
        self.arme_bd2 = modele2.get_arme_bd()
        self.categorie_bd2 = modele2.get_categorie_bd()
        self.cometition_bd2 = modele2.get_competition_bd()
        self.escripeur_bd2 = modele2.get_escrimeur_bd()
        self.inscrire_arbitre_bd2 = modele2.get_inscrire_arbitre_bd()
        self.touche_bd2 = modele2.get_touche_bd()
        self.organisateur_bd2 = modele2.get_organisateur_bd()
        self.poule_bd2 = modele2.get_poule_bd()
        self.phase_finale_bd2 = modele2.get_phase_finale_bd()
        self.phase_bd2 = modele2.get_phase_bd()
        self.match_bd2 = modele2.get_match_bd()
        self.lieu_bd2 = modele2.get_lieu_bd()
        self.inscrire_bd2 = modele2.get_inscrire_bd()
        mock_connexion = Mock()
        mock_connexion.execute.side_effect = Exception(
            "Une erreur s'est produite lors de l'exécution de la requête")
        self.club_bd2._ClubBD__connexion = mock_connexion
        self.arme_bd2._ArmeBD__connexion = mock_connexion
        self.categorie_bd2._CategorieBD__connexion = mock_connexion
        self.cometition_bd2._CompetitionBD__connexion = mock_connexion
        self.escripeur_bd2._EscrimeurBD__connexion = mock_connexion
        self.inscrire_arbitre_bd2._InscrireArbitreBD__connexion = mock_connexion
        self.touche_bd2._ToucheBD__connexion = mock_connexion
        self.organisateur_bd2._OrganisateurBD__connexion = mock_connexion
        self.poule_bd2._PouleBD__connexion = mock_connexion
        self.phase_finale_bd2._PhaseFinaleBD__connexion = mock_connexion
        self.phase_bd2._PhaseBD__connexion = mock_connexion
        self.match_bd2._MatchBD__connexion = mock_connexion
        self.lieu_bd2._LieuBD__connexion = mock_connexion
        self.inscrire_bd2._InscrireBD__connexion = mock_connexion
