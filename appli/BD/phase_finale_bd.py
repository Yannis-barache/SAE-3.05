...
class PhaseFinaleBD:
    ...
    def generer_tour_suivant(self, phase_finale: PhaseFinal, id_compet: int, heure_debut: float):
        """
        ...
        try:
            ...
            les_matchs = phase_finale.generer_tour_suivant(les_arbitres, heure_debut)
            for m in les_matchs:
